...
| Folder | Description |
| :--- | :--- |
| **Array Lists (Static)** | Implementation of fixed-size array lists. |
| **Array Lists (Dynamic)** | Resizable array implementations. |
| **Singly & Doubly** | Linked List implementations (Singly and Doubly linked). |
| **Stack & Deque** | LIFO structures and Double-ended queues. |
| **Trees** | Binary Trees, BSTs, and other hierarchical structures. |
